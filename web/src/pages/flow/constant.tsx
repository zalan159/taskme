...
export const operatorIconMap = {
  ...
  [Operator.PhotoDescribe]: PictureOutlined,
};
...
export const initialPhotoDescribeValues = {
  ...initialLlmBaseValues,
  prompt: i18n.t('flow.promptText'),
  cite: true,
  message_history_window_size: 12,
...
export const RestrictedUpstreamMap = {
  ...
  [Operator.PhotoDescribe]: [Operator.Begin, Operator.Relevant],
  [Operator.Message]: [
    Operator.Begin,
    Operator.Message,
    Operator.Generate,
...
export const NodeMap = {
  ...
  [Operator.PhotoDescribe]: 'generateNode',
