export default {
  translation: {
    common: {
      ...
      nextPage: 'Next',
      editTag: 'Edit Permissions and Tags',
      private: 'private',
      team: 'team',
      public: 'public',
      confirm: 'confirm',
      ...
      tags: 'tags',
      selectVisibleTeams: 'Select visible teams',
    },
    login: {
      login: 'Sign in',
      signUp: 'Sign up',
    ...
    knowledgeList: {
      ...
      publicKnowledge: 'Public Knowledge Base',
      teamKnowledge: 'Team Knowledge Base',
      privateKnowledge: 'Private Knowledge Base',
    },
    knowledgeDetails: {
      dataset: 'Dataset',
...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    setting: {
      ...
      mcpModel: 'MCP Model',
      mcpModelTip:
        'The default MCP model will be used in the MCP client component.',
      workspace: 'Workspace',
      upgrade: 'Upgrade',
      addLlmTitle: 'Add LLM',
    ...
    flow: {
      ...
      photoDescribeDescription: 'A component that describes a photo.',
