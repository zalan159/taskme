export default {
  translation: {
    ...
    flow: {
      ...
      mcp: 'Protocolo de Control de Mensajes',
      mcpDescription:
        'Este componente se utiliza para manejar el protocolo de control de mensajes, puede formatear y transformar mensajes.',
    },
    footer: {
