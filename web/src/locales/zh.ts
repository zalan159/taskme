export default {
  translation: {
    ...
    knowledgeList: {
      ...
      noMoreData: '没有更多数据了',
      publicKnowledge: '公共知识库',
      teamKnowledge: '团队知识库',
      privateKnowledge: '私有知识库',
    },
    knowledgeDetails: {
      dataset: '数据集',
      testing: '检索测试',
...
General：实体和关系提取提示来自 GitHub - microsoft/graphrag：基于图形的模块化检索增强生成 (RAG) 系统`,
    ...
    setting: {
      ...
      mcpModel: 'MCP模型',
      mcpModelTip: '默认的MCP模型会被使用在MCP客户端组件中.',
      rerankModel: 'Rerank模型',
    ...
    message: {
      ...
      networkAnomaly: '网络异常',
      hint: '提示',
      noPermissionToDelete: '您没有权限删除此知识库',
    },
    fileManager: {
      name: '名称',
      uploadDate: '上传日期',
    ...
    flow: {
      ...
      photoDescribe: '照片描述',
      photoDescribeDescription: '一个组件，用于描述照片。',
      flow: '工作流',
      cite: '引用',
      citeTip: '引用',
      name: '名称',
