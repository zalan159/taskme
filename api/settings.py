...
LLM_FACTORY = None
LLM_BASE_URL = None
CHAT_MDL = "qwen-plus@Tongyi-Qianwen"
EMBEDDING_MDL = "text-embedding-v3@Tongyi-Qianwen"
RERANK_MDL = "gte-rerank@Tongyi-Qianwen"
ASR_MDL = ""
IMAGE2TEXT_MDL = "qwen-vl-plus@Tongyi-Qianwen"
API_KEY = None
PARSERS = None
HOST_IP = None
HOST_PORT = None
